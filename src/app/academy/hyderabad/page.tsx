    ...
    <div className="min-h-screen bg-[#0a0a0a]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 w-full h-full">
          ...
          <div className="hidden md:block relative h-full w-full overflow-hidden p-24 lg:p-32 xl:p-48">
            <div className="w-full h-full relative rounded-2xl overflow-hidden group/menu-img">
              <Image src="/assets/hyderabad_page1.jpeg" alt="Racing" fill className="object-cover grayscale hover:grayscale-0 transition-all duration-700 scale-110 group-hover/menu-img:scale-100" />
      ...
      <main className="pt-28 sm:pt-36 md:pt-40 pb-20 sm:pb-28 md:pb-36 px-5 sm:px-8 md:px-12 lg:px-20 max-w-[1200px] mx-auto">
        ...
        <div className="academy-banner relative w-full aspect-[16/9] rounded-2xl overflow-hidden mb-16 sm:mb-20">
          <Image src="/assets/hyderabad.jpeg" alt="Hyderabad Karting Academy" fill className="object-cover" />
        ...
        <div className="academy-content">
          ...
          <h2 className="font-[family-name:var(--font-bebas)] text-white text-2xl sm:text-3xl md:text-4xl tracking-wide mb-6">
            HYDERABAD KARTING ACADEMY
          </h2>

          <div className="max-w-3xl space-y-4 mb-10">
            <p className="text-white/70 text-sm sm:text-base leading-relaxed">
              The Hyderabad Karting Academy is an intensive 2-day high-performance training program designed to build professional race craft and competitive mindset. This program is structured to develop strong technical fundamentals while giving drivers clarity on how to progress in motorsport at a national and international level.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 mb-16 sm:mb-20">
            ...
            <div className="bg-[#111111] rounded-xl p-5 sm:p-6 border border-white/[0.08]">
              ...
              <p className="font-[family-name:var(--font-bebas)] text-white text-lg sm:text-xl tracking-wide">30–31 March</p>
            </div>
            <div className="bg-[#111111] rounded-xl p-5 sm:p-6 border border-white/[0.08]">
              <p className="text-white/40 text-xs tracking-widest uppercase mb-2">Head Coach</p>
              <p className="font-[family-name:var(--font-bebas)] text-white text-lg sm:text-xl tracking-wide">Vineet Mane</p>
            </div>
            <div className="bg-[#111111] rounded-xl p-5 sm:p-6 border border-white/[0.08]">
              <p className="text-white/40 text-xs tracking-widest uppercase mb-2">Program Fee</p>
              <p className="font-[family-name:var(--font-bebas)] text-cyan text-lg sm:text-xl tracking-wide">₹11,999</p>
              <p className="text-white/40 text-xs mt-1">Early Bird: <span className="text-cyan">₹11,499</span></p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
            <div className="relative aspect-[4/3] rounded-xl overflow-hidden">
              <Image src="/assets/hyderabad_page2.jpeg" alt="Track walk at Hyderabad" fill className="object-cover hover:scale-105 transition-transform duration-700" />
            </div>
            <div className="relative aspect-[4/3] rounded-xl overflow-hidden">
              <Image src="/assets/hyderabad_page3.jpeg" alt="Karts lined up at Hyderabad" fill className="object-cover hover:scale-105 transition-transform duration-700" />
            </div>
          </div>
          <div className="grid grid-cols-2 gap-4 sm:gap-6 mb-16 sm:mb-20">
            <div className="relative aspect-[4/3] rounded-xl overflow-hidden">
              <Image src="/assets/hyderabad_page4.jpeg" alt="Track walkthrough at Hyderabad" fill className="object-cover hover:scale-105 transition-transform duration-700" />
            </div>
            <div className="relative aspect-[4/3] rounded-xl overflow-hidden">
              <Image src="/assets/hyderabad_page5.jpeg" alt="Kart racing grid at Hyderabad" fill className="object-cover hover:scale-105 transition-transform duration-700" />
            </div>
          </div>
          ...
          <div className="mb-16 sm:mb-20">
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-sm font-medium tracking-[0.2em] uppercase text-white/70">What You&apos;ll Learn</span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
              ...
              <div className="bg-[#111111] rounded-2xl p-6 sm:p-8 border border-white/[0.08]">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="font-[family-name:var(--font-bebas)] text-white text-xl tracking-wide">Technical Foundations</p>
                  </div>
                </div>
              ...
              <div className="bg-[#111111] rounded-2xl p-6 sm:p-8 border border-white/[0.08]">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <p className="text-white/40 text-xs tracking-widest uppercase">Day</p>
                    <p className="font-[family-name:var(--font-bebas)] text-white text-xl tracking-wide">Competitive Application &amp; Career Strategy</p>
                  </div>
                </div>
                <ul className="space-y-3">
                  {[
                    ...
                    "Structured roadmap from national to international motorsport",
                    "Strategic guidance for long-term racing progression",
                  ].map((item) => (
                    <li key={item} className="flex items-start gap-3 text-white/60 text-sm">
                      <span className="w-1 h-1 rounded-full bg-cyan mt-2 flex-shrink-0" />
                      {item}
          ...
          {/* ── Action shot ── */}
          <div className="relative w-full aspect-[21/9] rounded-2xl overflow-hidden mb-16 sm:mb-20">
            <Image src="/assets/hyderabad._page6.jpeg" alt="Racing action at Hyderabad" fill className="object-cover" />
          ...
          <div className="mb-16 sm:mb-20 bg-gradient-to-br from-[#111111] to-[#0d1a1a] rounded-2xl p-6 sm:p-8 border border-cyan/10">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-sm font-medium tracking-[0.2em] uppercase text-white/70">Performance Recognition</span>
            </div>
            <p className="text-white/70 text-sm sm:text-base leading-relaxed">
              Top 3 performers will receive <span className="text-cyan font-medium">exclusive discounts</span> on upcoming Formula Car training and testing programs.
            </p>
          </div>
          ...
          <div className="mb-16 sm:mb-20">
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-sm font-medium tracking-[0.2em] uppercase text-white/70">Pricing</span>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl">
              <div className="bg-[#111111] rounded-2xl p-6 sm:p-8 border border-white/[0.08] text-center">
                <p className="text-white/40 text-xs tracking-widest uppercase mb-3">Program Fee</p>
                <p className="font-[family-name:var(--font-bebas)] text-white text-3xl sm:text-4xl tracking-wide">₹11,999</p>
              </div>
              <div className="bg-[#111111] rounded-2xl p-6 sm:p-8 border border-cyan/20 text-center relative overflow-hidden">
                <div className="absolute top-0 right-0 bg-cyan text-black text-[10px] font-bold tracking-widest uppercase px-3 py-1 rounded-bl-lg">Save ₹500</div>
                <p className="text-white/40 text-xs tracking-widest uppercase mb-3">Early Bird Offer</p>
                <p className="font-[family-name:var(--font-bebas)] text-cyan text-3xl sm:text-4xl tracking-wide">₹11,499</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-16 sm:mb-20 bg-[#111111] rounded-2xl p-6 sm:p-8 border border-white/[0.08] max-w-2xl">
            ...
            <p className="text-white/60 text-sm leading-relaxed">
              Seat confirmation will be provided after payment. Kindly share the payment screenshot on WhatsApp to secure your position.
            </p>
          </div>

          {/* ── Bottom Image ── */}
          <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden mb-16">
            <Image src="/assets/hyderabad_page1.jpeg" alt="Group photo at Hyderabad Academy" fill className="object-cover" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent" />
          </div>

          {/* ── CTA ── */}
          <div className="text-center">
            <p className="text-white/50 text-sm mb-6 tracking-wide">Ready to start your racing journey?</p>
      ...
      <div className="fixed bottom-0 left-0 w-full z-[60] bg-gradient-to-t from-black via-black/95 to-transparent pointer-events-none pb-4 pt-10 sm:pb-5 sm:pt-12">
        <div className="max-w-[1200px] mx-auto px-5 sm:px-8 md:px-12 lg:px-20 flex items-center justify-between pointer-events-auto">
          <div className="hidden sm:flex flex-col">
            <span className="font-[family-name:var(--font-bebas)] text-white text-lg tracking-wide">HYDERABAD ACADEMY</span>
            <span className="text-white/40 text-xs">Starting from <span className="text-cyan font-semibold">₹11,499</span></span>
          </div>
