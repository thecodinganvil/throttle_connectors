    ...
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <main className="pt-28 sm:pt-36 md:pt-40 pb-20 sm:pb-28 md:pb-36 px-5 sm:px-8 md:px-12 lg:px-20 max-w-[1200px] mx-auto">
        ...
        <div className="academy-banner relative w-full aspect-[16/9] rounded-2xl overflow-hidden mb-16 sm:mb-20">
          <Image
            src="/assets/hyderabad.jpeg"
            alt="Hyderabad Karting Academy"
            fill
        ...
        <div className="academy-content">
          ...
          <div className="max-w-3xl space-y-4 mb-10">
            <p className="text-white/70 text-sm sm:text-base leading-relaxed">
              The Hyderabad Karting Academy is an intensive 2-day
              high-performance training program designed to build professional
              race craft and competitive mindset. This program is structured to
              develop strong technical fundamentals while giving drivers clarity
              on how to progress in motorsport at a national and international
              level.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 mb-16 sm:mb-20">
            ...
            <div className="bg-[#111111] rounded-xl p-5 sm:p-6 border border-white/[0.08]">
              ...
              <p className="text-white/40 text-xs mt-1">
                Early Bird: <span className="text-cyan">₹11,499</span>
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
            <div className="relative aspect-[4/3] rounded-xl overflow-hidden">
              <Image
                src="/assets/hyderabad_page2.jpeg"
                alt="Track walk at Hyderabad"
                fill
            ...
            <div className="relative aspect-[4/3] rounded-xl overflow-hidden">
              <Image
                src="/assets/hyderabad_page3.jpeg"
                alt="Karts lined up at Hyderabad"
                fill
                className="object-cover hover:scale-105 transition-transform duration-700"
              />
            </div>
          ...
          <div className="grid grid-cols-2 gap-4 sm:gap-6 mb-16 sm:mb-20">
            <div className="relative aspect-[4/3] rounded-xl overflow-hidden">
              <Image
                src="/assets/hyderabad_page4.jpeg"
                alt="Track walkthrough at Hyderabad"
                fill
                className="object-cover hover:scale-105 transition-transform duration-700"
              />
            </div>
            <div className="relative aspect-[4/3] rounded-xl overflow-hidden">
              <Image
                src="/assets/hyderabad_page5.jpeg"
                alt="Kart racing grid at Hyderabad"
                fill
                className="object-cover hover:scale-105 transition-transform duration-700"
              />
            </div>
              ...
              <div className="bg-[#111111] rounded-2xl p-6 sm:p-8 border border-white/[0.08]">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="font-[family-name:var(--font-bebas)] text-white text-xl tracking-wide">
                      Competitive Application &amp; Career Strategy
                    </p>
                  </div>
                </div>
                <ul className="space-y-3">
          ...
          <div className="relative w-full aspect-[21/9] rounded-2xl overflow-hidden mb-16 sm:mb-20">
            <Image
              src="/assets/hyderabad._page6.jpeg"
              alt="Racing action at Hyderabad"
              fill
              className="object-cover"
            />
          ...
          <div className="mb-16 sm:mb-20 bg-gradient-to-br from-[#111111] to-[#0d1a1a] rounded-2xl p-6 sm:p-8 border border-cyan/10">
            ...
            <p className="text-white/70 text-sm sm:text-base leading-relaxed">
              ...
              <span className="text-cyan font-medium">exclusive discounts</span>{" "}
              on upcoming Formula Car training and testing programs.
            </p>
          </div>
          ...
          <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden mb-16">
            <Image
              src="/assets/hyderabad_page1.jpeg"
              alt="Group photo at Hyderabad Academy"
              fill
              className="object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent" />
