    ...
    <div className="min-h-screen bg-[#0a0a0a]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 w-full h-full">
          ...
          <div className="hidden md:block relative h-full w-full overflow-hidden p-24 lg:p-32 xl:p-48">
            <div className="w-full h-full relative rounded-2xl overflow-hidden group/menu-img">
              <Image src="/assets/bangalore_page1.jpeg" alt="Racing" fill className="object-cover grayscale hover:grayscale-0 transition-all duration-700 scale-110 group-hover/menu-img:scale-100" />
      ...
      <main className="pt-28 sm:pt-36 md:pt-40 pb-20 sm:pb-28 md:pb-36 px-5 sm:px-8 md:px-12 lg:px-20 max-w-[1200px] mx-auto">
        ...
        <h1 className="academy-hero-title font-[family-name:var(--font-bebas)] text-cyan text-4xl sm:text-6xl md:text-7xl lg:text-8xl leading-[0.95] tracking-tight mb-4 sm:mb-6">
          BANGALORE KARTING<br/>&amp; FORMULA CAR ACADEMY
        </h1>
        ...
        <div className="academy-banner relative w-full aspect-[16/9] rounded-2xl overflow-hidden mb-16 sm:mb-20">
          <Image src="/assets/bangalore.jpeg" alt="Bangalore Karting & Formula Car Academy" fill className="object-cover" />
        ...
        <div className="academy-content">
          ...
          <div className="max-w-3xl space-y-4 mb-10">
            <p className="text-white/70 text-sm sm:text-base leading-relaxed">
              For the first time in Indian grassroots motorsport, a structured Karting + Formula Car Academy is being conducted in Bangalore. This 3-day academy is designed to bridge the gap between karting fundamentals and professional formula racing exposure.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-16 sm:mb-20">
            ...
            <div className="bg-[#111111] rounded-xl p-5 sm:p-6 border border-white/[0.08]">
              ...
              <p className="font-[family-name:var(--font-bebas)] text-white text-lg sm:text-xl tracking-wide">3 Days Intensive Program</p>
            </div>
            <div className="bg-[#111111] rounded-xl p-5 sm:p-6 border border-white/[0.08]">
              <p className="text-white/40 text-xs tracking-widest uppercase mb-2">Program Fee</p>
              <p className="font-[family-name:var(--font-bebas)] text-cyan text-lg sm:text-xl tracking-wide">₹26,999</p>
              <p className="text-white/40 text-xs mt-1">Early Bird: <span className="text-cyan">₹24,999</span></p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
            <div className="relative aspect-[4/3] rounded-xl overflow-hidden">
              <Image src="/assets/bangalore_page3.jpeg" alt="Karting grid lineup at Bangalore" fill className="object-cover hover:scale-105 transition-transform duration-700" />
            </div>
            <div className="relative aspect-[4/3] rounded-xl overflow-hidden">
              <Image src="/assets/bangalore_page4.jpeg" alt="Track walk at Bangalore" fill className="object-cover hover:scale-105 transition-transform duration-700" />
            </div>
          </div>
          <div className="relative w-full aspect-[16/9] rounded-xl overflow-hidden mb-16 sm:mb-20">
            <Image src="/assets/bangalore_page5.jpeg" alt="Kart racing action at Bangalore" fill className="object-cover hover:scale-105 transition-transform duration-700" />
          </div>
          ...
          <div className="mb-16 sm:mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 mb-8 md:mb-12">
              ...
              <div className="bg-[#111111] rounded-2xl p-6 sm:p-8 border border-white/[0.08]">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="font-[family-name:var(--font-bebas)] text-white text-xl tracking-wide">Technical Karting Foundations</p>
                  </div>
                </div>
              ...
              <div className="bg-[#111111] rounded-2xl p-6 sm:p-8 border border-white/[0.08]">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <p className="text-white/40 text-xs tracking-widest uppercase">Day</p>
                    <p className="font-[family-name:var(--font-bebas)] text-white text-xl tracking-wide">Competitive Karting Application</p>
                  </div>
                </div>
                <ul className="space-y-3">
                  {[
            ...
            <div className="bg-[#111111] rounded-2xl p-6 sm:p-8 border border-white/[0.08]">
              <div className="flex items-center gap-3 mb-6">
                <span className="font-[family-name:var(--font-bebas)] text-cyan text-5xl sm:text-6xl leading-none">03</span>
                <div>
                  <p className="text-white/40 text-xs tracking-widest uppercase">Day</p>
                  <p className="font-[family-name:var(--font-bebas)] text-white text-xl tracking-wide">Formula Car Exposure &amp; Motorsport Pathway</p>
                </div>
              </div>
          ...
          <div className="relative w-full aspect-[21/9] rounded-2xl overflow-hidden mb-16 sm:mb-20">
            <Image src="/assets/academy_page2.jpeg" alt="Racing action at the academy" fill className="object-cover" />
          ...
          <div className="mb-16 sm:mb-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl">
              <div className="bg-[#111111] rounded-2xl p-6 sm:p-8 border border-white/[0.08] text-center">
                ...
                <p className="font-[family-name:var(--font-bebas)] text-white text-3xl sm:text-4xl tracking-wide">₹26,999</p>
              </div>
              <div className="bg-[#111111] rounded-2xl p-6 sm:p-8 border border-cyan/20 text-center relative overflow-hidden">
                <div className="absolute top-0 right-0 bg-cyan text-black text-[10px] font-bold tracking-widest uppercase px-3 py-1 rounded-bl-lg">Save ₹2,000</div>
                <p className="text-white/40 text-xs tracking-widest uppercase mb-3">Early Bird Offer</p>
                <p className="font-[family-name:var(--font-bebas)] text-cyan text-3xl sm:text-4xl tracking-wide">₹24,999</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-16 sm:mb-20 bg-[#111111] rounded-2xl p-6 sm:p-8 border border-white/[0.08] max-w-2xl">
            ...
            <p className="text-white/60 text-sm leading-relaxed">
              After completing the payment, kindly send the payment screenshot on WhatsApp to confirm your seat.
            </p>
          </div>

          {/* ── Bottom Image ── */}
          <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden mb-16">
            <Image src="/assets/bangalore_page1.jpeg" alt="Formula car racing at Bangalore" fill className="object-cover" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent" />
          </div>
      ...
      <div className="fixed bottom-0 left-0 w-full z-[60] bg-gradient-to-t from-black via-black/95 to-transparent pointer-events-none pb-4 pt-10 sm:pb-5 sm:pt-12">
        <div className="max-w-[1200px] mx-auto px-5 sm:px-8 md:px-12 lg:px-20 flex items-center justify-between pointer-events-auto">
          <div className="hidden sm:flex flex-col">
            <span className="font-[family-name:var(--font-bebas)] text-white text-lg tracking-wide">BANGALORE ACADEMY</span>
            <span className="text-white/40 text-xs">Starting from <span className="text-cyan font-semibold">₹24,999</span></span>
          </div>
